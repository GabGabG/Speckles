...
class SpecklesTorchDataset(Dataset):
	...
	def __distribution(self, image_flat: torch.Tensor, eigenvals: np.ndarray) -> Dict[str, torch.Tensor]:
...
if __name__ == '__main__':
	...
	trainer = nt.Trainer(
		model=model,
		predict_method=("get_theta_moments" if _re_moments else "get_log_dist"),
